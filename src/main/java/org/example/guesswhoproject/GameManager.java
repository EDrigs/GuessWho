...
public class GameManager {
    ...
    public String[] getQuestions() {
        return new String[]{"Does the character have glasses?",
                ...
                "Does the character have blond hair?",
    ...
    private ArrayList<GameCharacter> initCharacters() {
        GameCharacter alex = new GameCharacter("Alex", false, true, "brown", "short", "brown");
        ...
        GameCharacter david = new GameCharacter("David", false, true, "blond", "medium", "brown");
        GameCharacter eric = new GameCharacter("Eric", false, true, "blond", "short", "brown");
        ...
        GameCharacter joe = new GameCharacter("Joe", true, true, "blond", "short", "brown");
