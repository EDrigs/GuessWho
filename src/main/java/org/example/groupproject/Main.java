...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        instructions.setContentText("Instructions: You may ask 5 questions to find out the mystery character. " +
                "You have three guesses, so use them wisely! Click on a character to mark them eliminated!");
